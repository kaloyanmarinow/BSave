...
<body>
	<div class="wrapper">
		<div class="wrapper__aside-alt"></div>
		...
		<div class="section-contacts section-contacts--alt">
			<div class="shell section__shell section__shell--alt">
				<div class="section__title">
					<h2>
						About <span>BSave</span>
					</h2>
				</div>

				<div class="section__content">
					<p>Have you ever wondered how much do you spend on things you want and don't need? Why is it so hard for you to save up some money?

					<p>With the help of bSave you can do that easily and not for a monthly fee but for free!</p>

					<p>Our platform aims to help you manage your finances. Get a better view of your income and your expenses.
					You might think twice next time you buy something that not only isn't essential but you don't even use after a week.</p>
				</div>
			</div>
		</div>
	</div><!-- /.wrapper -->
